...
const SearchResult = () => {
  ...
  <ol class="space-y-4 list-inside dark:text-gray-400 pt-5">
   <li className= ' text-black '>
     ...
     onError={(e) => {
      e.target.src = bookI;  }}
       alt="book_display" className='flex justify-center h-32 w-28 sm:h-full sm:w-36 mt-2'></img>
      <div>
      ...
      <ul class="ps-5 mt-2 mb-4  space-y-1 list-disc list-inside">
         <li className= ' text-sm sm:text-[16px] pt-4 text-gray-700 '> {book.searchInfo && book.searchInfo.textSnippet? book.searchInfo.textSnippet: 'No description found'}</li>
      </ul>
      </div>
      </div>
   </li>
